...
async function getDashboardSummary() {
  ...
  return {
    ...
    totalFailedSends,
    lastEnrollmentAt: lastEnrollment ? lastEnrollment.createdAt : null,
    lastLinkSentAt: lastSentEnrollment ? lastSentEnrollment.linkSentAt : null,
  };
}

async function getAdminEnrollments(query) {
  const filters = {
    registrationStatus: 'confirmed',
    paymentStatus: 'paid',
  };
...
async function getAdminClassOfferings() {
